<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="校区联系电话" prop="phone">
        <el-input
          v-model="queryParams.phone"
          placeholder="请输入校区联系电话"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:campus:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:campus:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="campusList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="校区联系电话" align="center" prop="phone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="校区联系电话" prop="phone">
          <el-input v-model="form.phone" placeholder="请输入校区联系电话" />
        </el-form-item>
      </el-form>
...
<script>
import { listCampus, getCampus, delCampus, addCampus, updateCampus } from "@/api/system/campus"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + campusIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/campus/export', {
        ...this.queryParams
