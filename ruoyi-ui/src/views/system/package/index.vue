<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="课程包" prop="packageName">
        <el-input
    ...
    <el-table v-loading="loading" :data="packageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程包id" align="center" prop="id" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="课程包" prop="packageName">
          <el-input v-model="form.packageName" placeholder="请输入课程包" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课程包管理编号为"' + ids + '"的数据项？').then(function() {
